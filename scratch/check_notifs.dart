...
void main() async {
  ...
  var response = await client.get(Uri.parse('https://foodchart.free.nf/api/notifications/index.php'), headers: headers);
  if (response.body.contains('slowAES.decrypt') && response.body.contains('toNumbers(')) {
    ...
    if (matches.length >= 3) {
      ...
      response = await client.get(Uri.parse('https://foodchart.free.nf/api/notifications/index.php'), headers: headers);
    }
  }
